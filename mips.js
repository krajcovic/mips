...
function checkForm(){
	var goOn = true;
	if(document.offlinepaymentForm.cardholderName.value === ""){
	...
	if(document.offlinepaymentForm.cardCVC.value === ""){
...
function checkMipsForm(){
	var goOn = true;
	if(document.mipspaymentForm.merchantOrder.value === ""){
		document.getElementById('errMerchantOrder').style.display = "block";
		goOn = false;
	} else {
		document.getElementById('errMerchantOrder').style.display = "none";}
...
function doSetup()
{
		document.offlinepaymentForm.onsubmit = checkMipsForm;
}
